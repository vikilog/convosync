...
export function mapTemplateFromApi(raw: Record<string, unknown>): CampaignTemplate {
  ...
  return {
    ...
    headerFormat: raw.headerFormat ? String(raw.headerFormat) : undefined,
    headerMediaStorageKey: raw.headerMediaStorageKey
      ? String(raw.headerMediaStorageKey)
      : undefined,
    headerMediaMimeType: raw.headerMediaMimeType ? String(raw.headerMediaMimeType) : undefined,
    headerMediaFileName: raw.headerMediaFileName ? String(raw.headerMediaFileName) : undefined,

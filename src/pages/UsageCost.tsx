...
function SummaryCard({
  ...
  return (
    <div
      className="relative overflow-hidden rounded-xl border-l-4 p-4 transition-shadow "
...
function WhatsAppPieTooltip({
  ...
  return (
    <div className="rounded-lg bg-white ring-1 ring-swiss-line px-3 py-2 text-xs shadow-lg">
...
function DailyTokensTooltip({
  ...
  const row = payload[0].payload;
  return (
    <div className="rounded-lg bg-white ring-1 ring-swiss-line px-2.5 py-1.5 text-xs ">
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={`usage-stat-${i}`}
            className="bg-white border border-swiss-line p-4 space-y-3 animate-pulse"
          >
            <div className="flex items-start gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:justify-end">
          <div className="relative">
            ...
            <select
              ...
              disabled={loading}
              className="cursor-pointer appearance-none rounded-lg bg-white ring-1 ring-swiss-line py-2 pl-9 pr-9 text-sm font-medium text-slate-800 transition-colors hover:border-black/10 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/10 disabled:opacity-60"
            >
              {monthOptions.map((m) => (
          ...
          <button
            type="button"
            className="inline-flex cursor-pointer items-center gap-2 rounded-lg bg-white ring-1 ring-swiss-line px-4 py-2 text-sm font-semibold text-slate-700 transition-colors hover:border-black/10 hover:bg-surface-muted"
          >

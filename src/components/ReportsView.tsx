...
export const ReportsView: React.FC = () => {
  ...
  return (
    <div className="flex-1 space-y-6 max-w-7xl mx-auto pb-12 text-left selection:bg-sky-50">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-white ring-1 ring-slate-200/80 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.01)] select-none">
        <div>
        ...
        <div className="flex items-center gap-2 bg-white p-1.5 rounded-xl border border-black/5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {reportsData.map((data, idx) => {
          ...
          return (
            <div key={idx} className="bg-white p-5 rounded-2xl border border-black/5 hover:border-primary/10 hover:shadow-md transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Weekly Hour density */}
        <div className="lg:col-span-8 bg-white ring-1 ring-slate-200/80 p-6 rounded-2xl flex flex-col text-left">
          <div className="mb-6">
        ...
        <div className="lg:col-span-4 bg-white ring-1 ring-slate-200/80 rounded-2xl flex flex-col overflow-hidden h-[360px]">
          <div className="p-4 border-b border-black/5 bg-white text-left">

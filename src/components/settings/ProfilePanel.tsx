...
const inputClass =
  'mt-1 w-full rounded-xl border border-swiss-line px-3 py-2.5 text-sm text-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-swiss-accent/20';
  ...
  if (loading) {
    return (
      <div className="flex justify-center py-16">
        <Loader2 className="h-6 w-6 animate-spin text-swiss-accent" />
      </div>
    );
  }
      ...
      <AnimatePresence initial={false}>
        {message ? (
          <motion.p
            ...
            className="overflow-hidden rounded-xl border border-swiss-accent/20 bg-swiss-accent/10 px-3 py-2 text-sm font-medium text-swiss-accent"
          >
            {message}
          </motion.p>
        ) : null}
          ...
          <div className={cardClass}>
              ...
              <div className="block">
                ...
                <div className="mt-1 flex gap-2">
                  <Input
                    ...
                    value={profile.email}
                    disabled
                    className={`h-auto ${inputClass} mt-0 min-w-0 flex-1 cursor-not-allowed bg-white text-slate-500`}
                  />
                  {emailVerified ? (
            ...
            <div className="border-t border-slate-100 pt-5">
              <div className="mb-1 flex items-center gap-2">
                <Globe className="h-4 w-4 text-swiss-accent" aria-hidden />
            ...
            <div className="flex justify-end border-t border-slate-100 pt-4">
              <button
                ...
                className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-swiss-accent px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-swiss-accent-hover active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {savingAccount ? (
          ...
          <div className={cardClass}>
            ...
            >
              <span className="flex items-center gap-2">
                <Lock className="h-4 w-4 text-swiss-accent" aria-hidden />
            ...
            <div className="flex flex-col items-center text-center">
              ...
              >
                {avatarUrl ? (
                  ...
                  <div className="flex h-24 w-24 items-center justify-center rounded-full border border-swiss-line bg-swiss-accent/10 text-3xl font-semibold text-swiss-accent">
                    {initials}
                  </div>
                )}
                <span
                ...
                <span className="pointer-events-none absolute bottom-0 right-0 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-swiss-accent text-white shadow-sm transition-transform group-hover:scale-110">
              ...
              {profile.role ? (
                <span className="mt-1.5 inline-flex items-center gap-1 rounded-full bg-swiss-accent/10 px-2.5 py-0.5 text-[11px] font-semibold capitalize text-swiss-accent ring-1 ring-swiss-accent/20">

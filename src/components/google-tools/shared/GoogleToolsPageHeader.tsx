...
export function GoogleToolsPageHeader({
  ...
  return (
    <header className="shrink-0 flex items-center justify-between gap-3 px-4 py-3 border-b border-black/5 bg-white min-w-0">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        {onRefresh && (
          <button
            ...
            onClick={onRefresh}
            title="Refresh"
            className="inline-flex items-center justify-center h-9 w-9 rounded-lg text-[#64748B] bg-white ring-1 ring-slate-200/80 hover:bg-surface-muted transition-colors"
          >
        ...
        <button
          ...
          disabled={syncing}
          onClick={onSync}
          className="inline-flex items-center gap-2 h-9 px-3 rounded-lg text-sm font-semibold border border-black/5 text-[#0F172A] bg-white hover:bg-surface-muted disabled:opacity-50 transition-colors"
        >

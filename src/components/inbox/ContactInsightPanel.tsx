  ...
  return (
    <div className="space-y-3">
      ...
      {!loading && !insight && !error && !excludeFromInsights && (
        <article className="rounded-2xl border border-swiss-line bg-white p-5 text-center">
      ...
      {!loading && insight && (
        <article className="rounded-2xl border border-swiss-line bg-white p-3 space-y-3">

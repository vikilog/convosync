    ...
    <div>
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-slate-200 bg-slate-50/80 py-2 pl-9 pr-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#833AB4] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#833AB4]/15"
        />
      </div>

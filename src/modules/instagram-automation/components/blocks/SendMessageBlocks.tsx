      ...
      {pickerOpen ? (
        <div className="rounded-xl border border-border-subtle bg-surface-muted/40 p-2">
                ...
                <button
                  ...
                  className={`flex flex-col items-start gap-1 rounded-lg border px-2.5 py-2 text-left transition-colors ${
                    disabled
                      ...
                      : 'border-slate-200 bg-white hover:border-primary/40 hover:bg-surface-muted/60'
                  }`}
                >
          ...
          {sendAs === 'private_reply' ? (
            <p className="mt-2 border-t border-slate-200 pt-2 text-[10px] leading-relaxed text-slate-400">
  ...
  return (
    <div
      className={`rounded-xl border p-3 ${
        disallowed ? 'border-amber-300 bg-amber-50/40' : 'border-slate-200 bg-white'
      }`}
    >
  ...
  return (
    <div className="space-y-2">
      ...
      <label className="block text-xs font-semibold text-gray-600">
        ...
        <input
          className="mt-1 w-full rounded-lg border border-slate-200 px-2 py-1.5 text-sm font-mono text-xs disabled:bg-slate-50 disabled:text-slate-400"
...
function CardFieldsEditor({
  ...
  return (
    <div className="space-y-2 rounded-lg border border-slate-100 bg-slate-50/60 p-2">
      ...
      <input
        className="w-full rounded-lg border border-slate-200 bg-white px-2 py-1.5 text-sm font-mono text-xs disabled:bg-slate-100 disabled:text-slate-400"
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        />
        <input
          className="rounded-lg border border-slate-200 bg-white px-2 py-1.5 text-sm font-mono text-xs"

      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-2xl w-full max-w-md border border-swiss-line overflow-hidden"
          ...
          >
            <div className="flex items-start justify-between px-5 py-4 border-b border-swiss-line">
              <div>
                <h2 id="journey-name-dialog-title" className="text-sm font-semibold text-swiss-ink">
                  {title}
                </h2>
                {description && (
                  <p className="text-meta text-swiss-muted mt-0.5">{description}</p>
                )}
              </div>
              <button
                type="button"
            ...
            <div className="p-5 space-y-3">
              <label className="block">
                <span className="text-sm font-bold text-swiss-ink">Journey name</span>
                <Input
                  type="text"
                  value={name}
                  onChange={(e) => {

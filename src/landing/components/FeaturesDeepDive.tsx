...
export default function FeaturesDeepDive() {
  ...
  return (
    <section id="features" className="bg-white border-b border-gray-100 py-24 text-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-display leading-tight tracking-tight mt-2 text-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {activeTab === 'inbox' && (
            <>
              <div className="lg:col-span-5 space-y-6">
                <span className="text-[10px] bg-brand-indigo/10 text-brand-indigo font-bold px-3 py-1 rounded-full uppercase font-mono">
                  Module 01
                </span>
                ...
                <ul className="space-y-3 text-xs sm:text-sm font-semibold text-gray-700">
                  <li className="flex items-center space-x-2.5">
                    <span className="w-5 h-5 rounded-full bg-indigo-50 flex items-center justify-center text-brand-indigo text-xs">✓</span>
              ...
              <div className="lg:col-span-7 bg-[#0A0A12] rounded-2xl border border-white/5 p-4 sm:p-5 text-white h-[420px] shadow-2xl relative overflow-hidden flex flex-col justify-between">
                ...
                <div className="grid grid-cols-12 gap-3 text-xs flex-grow h-[310px] overflow-hidden mt-3">
                  ...
                  <div className="col-span-4 border-r border-white/5 pr-2 space-y-2 py-1 overflow-y-auto">
                    ...
                    <div className="p-2 rounded-lg bg-transparent hover:bg-white/2 cursor-pointer transition-colors">
                      <div className="flex justify-between items-center">
                  ...
                  <div className="col-span-5 flex flex-col justify-between border-r border-white/5 px-2">
                    <div className="space-y-3 flex-grow overflow-y-auto py-1">
                      <div className="p-2.5 bg-white/5 border border-white/10 rounded-xl rounded-tl-none max-w-[90%] text-[10px]">
                        Hello support! Need to enroll Priya in the full cohort stack courses for Mumbai regional operations.
                      </div>
                      <div className="p-2.5 bg-brand-indigo/15 border border-brand-indigo/20 rounded-xl rounded-tr-none max-w-[90%] ml-auto text-[10px] text-indigo-100">
                  ...
                  <div className="col-span-3 pl-2 flex flex-col gap-3 py-1 text-[10px]">
                    <div className="p-2.5 bg-[#121220] rounded-xl border border-white/5">
                      <p className="text-[9px] text-gray-400 uppercase tracking-widest font-bold mb-1.5">CLIENT DIRECTORY</p>
                      <p className="font-extrabold text-white">Rahul Sharma</p>
                      <p className="text-gray-500 font-mono text-[9px] mt-0.5">mumb-executive@gmail.com</p>
                    </div>

                    <div className="bg-[#121220] rounded-xl border border-white/5 p-2.5 space-y-1.5">
                ...
                <div className="border-t border-white/5 pt-3 flex justify-between text-[10px] text-gray-400 font-mono">
          ...
          {activeTab === 'agents' && (
            <>
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="p-4 bg-brand-indigo/5 rounded-xl border border-brand-indigo/10 flex items-center space-x-3 text-xs text-brand-indigo">
              ...
              <div className="lg:col-span-7 bg-[#0A0A12] rounded-2xl border border-white/5 p-5 text-white h-[420px] shadow-2xl flex flex-col justify-between">
                <div className="flex items-center justify-between border-b border-white/5 pb-3.5">
                  <span className="text-xs font-bold text-gray-400">Agent Training Laboratory / Workspace</span>
                  <span className="text-[10px] text-brand-indigo bg-brand-indigo/10 px-2 py-0.5 rounded-md border border-brand-indigo/20 font-mono font-bold">SARA-PORTAL</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 flex-grow my-4 overflow-hidden">
                  ...
                  <div className="space-y-2.5 overflow-y-auto">
                    ...
                    <div className="p-3 bg-white/5 rounded-xl border border-brand-indigo/40 relative">
                    ...
                    <div className="p-3 bg-transparent hover:bg-white/2 rounded-xl border border-white/5 transition-colors cursor-pointer">
                      <div className="flex items-center justify-between">
                  ...
                  <div className="bg-[#121222] border border-white/5 rounded-xl p-4 flex flex-col justify-between overflow-hidden">
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1.5 overflow-y-auto max-h-[140px] pr-1">
                        {mockDocs.map((doc, dIdx) => (
                          <div key={dIdx} className="flex items-center justify-between p-1.5 bg-white/5 border border-white/5 rounded text-[10px] text-gray-300">
                    ...
                    <form onSubmit={handleAddDoc} className="flex gap-2.5 mt-3">
                      <input 
                        ...
                        className="bg-white/5 border border-white/10 rounded px-2.5 py-1.5 text-[10px] text-white flex-grow focus:outline-none focus:border-brand-indigo/50"
                      />
                      <button 
                        type="submit"
          ...
          {activeTab === 'campaigns' && (
            <>
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-3.5 bg-gray-50 rounded-xl border border-gray-100">
                    <p className="text-lg font-bold text-brand-indigo">97.9%</p>
                    <p className="text-[11px] text-gray-500 font-medium">WhatsApp Delivery Rate</p>
                  </div>
                  <div className="p-3.5 bg-gray-50 rounded-xl border border-gray-100">
                    <p className="text-lg font-bold text-brand-indigo">68.2%</p>
              ...
              <div className="lg:col-span-7 bg-[#0A0A12] rounded-2xl border border-white/5 p-5 text-white h-[420px] shadow-2xl flex flex-col justify-between">
                ...
                <div className="flex-grow flex items-center justify-center py-4 overflow-hidden">
                  ...
                  {wizardStep === 1 && (
                    <div className="text-center space-y-3 max-w-sm animate-fade-in w-full">
                      ...
                      <div className="grid grid-cols-2 gap-2.5 mt-2 text-left">
                        <div className="p-3 bg-white/5 border border-brand-indigo/40 rounded-xl">
                        ...
                        <div className="p-3 bg-white/2 border border-white/5 rounded-xl hover:bg-white/5 cursor-pointer">
                  ...
                  {wizardStep === 2 && (
                    <div className="text-center space-y-3 max-w-xs animate-fade-in w-full">
                      ...
                      <div className="bg-[#151525] border border-white/10 rounded-2xl p-3.5 text-left text-[11px] space-y-1.5 shadow-xl">
                        <p className="text-gray-300 font-mono leading-relaxed bg-[#202035] p-2 rounded border-l-2 border-channel-green">
                        ...
                        <div className="bg-white/5 text-gray-400 p-2.5 rounded text-center font-bold tracking-tight border border-white/5">
                  ...
                  {wizardStep === 3 && (
                    <div className="text-center space-y-3 animate-fade-in w-full">
                      ...
                      <div className="flex items-center justify-center space-x-12 mt-4 max-w-xs mx-auto border-t border-b border-white/5 py-4">
                        <div>
                ...
                <div className="border-t border-white/5 pt-3 text-[10px] text-gray-400 flex justify-between items-center font-mono">
          ...
          {activeTab === 'journeys' && (
            <>
              ...
              <div className="lg:col-span-7 bg-[#0A0A12] rounded-2xl border border-white/5 p-4 sm:p-6 text-white h-[420px] shadow-2xl flex flex-col justify-between overflow-hidden relative">
                <div className="flex items-center justify-between border-b border-white/5 pb-3.5">
                ...
                <div className="border-t border-white/5 pt-3.5 text-[10px] text-gray-500 font-mono flex justify-between">
          ...
          {activeTab === 'analytics' && (
            <>
              ...
              <div className="lg:col-span-7 bg-[#0A0A12] rounded-2xl border border-white/5 p-5 text-white h-[420px] shadow-2xl flex flex-col justify-between overflow-hidden">
                <div className="flex items-center justify-between border-b border-white/5 pb-3">
                  <span className="text-xs font-bold text-gray-400">Aggregated Performance Ledger</span>
                  <span className="text-[10px] text-brand-indigo font-mono">Updated: June 2026</span>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3 my-3">
                  ...
                  <div className="p-2.5 bg-white/5 rounded-xl border border-white/5 text-center">
                    ...
                    <p className="text-sm font-semibold text-indigo-300 mt-1">4.8/5</p>
                  </div>
                </div>

                {/* Simulated Channel Volume Bar Graph */}
                <div className="bg-[#121222] border border-white/5 rounded-xl p-4 flex-grow flex flex-col justify-between overflow-hidden">
                ...
                <div className="border-t border-white/5 pt-3.5 text-[10px] text-gray-500 flex justify-between items-center font-mono">
